...
const Footer = () => {
  ...
  <div class="container px-5 py-4 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2023 Project
...
<footer class="bg-white rounded-lg shadow dark:bg-gray-900 m-4">
    {/* <div class="w-full container mx-auto p-4 md:px-6 md:py-8">
        ...
        <span className="block p-4 text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" className="hover:underline">SEM4Project™</a>. All Rights Reserved.</span>
</footer>
